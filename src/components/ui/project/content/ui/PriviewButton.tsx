...
import { PriviewButtonProps } from "@/components/ui/project/types/project";

export const PriviewButton = ({ linkPreview }: PriviewButtonProps) => {
    return (
        <motion.div
