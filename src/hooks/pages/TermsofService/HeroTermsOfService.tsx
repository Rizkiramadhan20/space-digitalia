...
import banner from '@/base/assets/pages/kebijakanPrivacy/bg.jpg'

export default function HeroTermsOfService() {
            ...
            >
                ...
                >
                    ...
                    <div className="flex items-center gap-4 bg-white/10 px-8 py-3 rounded-full backdrop-blur-md border border-white/20 hover:bg-white/20 transition-all duration-300">
                        ...
                        <span className='text-sm md:text-base text-white/80'>Terms of Service</span>
                    </div>
                </motion.div>
            </motion.div>
        </div>
