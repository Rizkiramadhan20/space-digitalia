...
export default function ArticleLayout() {
    ...
    return (
        <motion.section
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className='min-h-full bg-gradient-to-b from-gray-50 to-white py-6 sm:py-10'
        >
                ...
                <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-8 mb-6 sm:mb-8'>
                    ...
                    <div className='search-filter w-full sm:w-auto'>
                        <button
                            ...
                            className="w-full sm:w-64 pl-8 sm:pl-10 pr-4 py-2 sm:py-2.5 border border-gray-200 rounded-full 
                                     flex items-center gap-2 sm:gap-3 hover:border-blue-500 hover:shadow-md transition-all duration-300
