...
import SecuritySkelaton from '@/hooks/dashboard/super-admins/settings/security/SecuritySkelaton'

import DeleteAccountModal from '@/hooks/dashboard/super-admins/settings/security/content/DeleteAccountModal'
