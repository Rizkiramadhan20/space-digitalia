...
import { Transaction } from '@/hooks/dashboard/user/transaction/free/lib/free'

import TransactionFreeSkeleton from '@/hooks/dashboard/user/transaction/free/TransactionFreeSkelaton'

import { Pagination } from '@/base/helper/Pagination'

import { useAuth } from '@/utils/context/AuthContext'

import EmptyFreeTransaction from '@/hooks/dashboard/user/transaction/free/content/empety'

export default function TransactionFreeLayout() {
    const { user } = useAuth()
    const [freeTransactions, setFreeTransactions] = useState<Transaction[]>([]);
    ...
    const paginatedTransactions = freeTransactions.slice(
    ...
    useEffect(() => {
        const fetchPendingTransactions = async () => {
            ...
            try {
                ...
                setFreeTransactions(sortedTransactions);
            } catch (error) {
    ...
    if (freeTransactions.length === 0) {
        return (
            <EmptyFreeTransaction />
        );
    }
    ...
    return (
        <section className='min-h-full px-0 sm:px-4'>
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-8">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div className="space-y-1">
                        ...
                        <p className='text-gray-500'>Kelola dan urutkan transaksi gratis anda</p>
                    </div>
                </div>
            </div>
                    ...
                    <div key={transaction.orderId} className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
                        ...
                        <div className="p-5">
                            ...
                            <div className="space-y-3">
                                {/* User Info */}
                                <div className="flex items-center gap-3 p-3 bg-gray-50 hover:bg-gray-100 transition-colors duration-200 rounded-lg">
            ...
            {/* Add Pagination */}
            {freeTransactions.length > 0 && (
                <Pagination
                    currentPage={currentPage}
                    totalPages={Math.ceil(freeTransactions.length / itemsPerPage)}
