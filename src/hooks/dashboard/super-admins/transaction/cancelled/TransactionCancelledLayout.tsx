...
import TransactionCancelledSkeleton from '@/hooks/dashboard/super-admins/transaction/cancelled/TransactionCancelledSkelaton'
...
export default function TransactionCancelledLayout() {
    ...
    useEffect(() => {
        const fetchCancelledTransactions = async () => {
            try {
                const q = query(
                    collection(db, process.env.NEXT_PUBLIC_COLLECTIONS_TRANSACTIONS as string),
                ...
                setCancelledTransactions(sortedTransactions)
    ...
    // Apply filters
    useEffect(() => {
        let filtered = [...cancelledTransactions]
    ...
    }, [cancelledTransactions, searchQuery, dateRange, selectedStatus])
    ...
    if (isLoading) {
        return <TransactionCancelledSkeleton />
    }
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-8">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div className="space-y-1">
                        ...
                        <p className='text-gray-500'>Manage and organize your cancelled transaction</p>
                    </div>
                        ...
                        <div className="p-5">
                            ...
                            <div className="flex justify-between items-start gap-4 mb-4">
                                ...
                                <div className="flex flex-col gap-2 items-end">
                                    <span className="inline-flex px-3 py-1 text-xs font-medium rounded-full bg-red-50 text-red-700 border border-red-200">
                                        Cancelled
                                    </span>
                                </div>
                            </div>
                            ...
                            <button
                                ...
                                className="w-full mt-4 px-4 py-2.5 bg-white border border-indigo-200 
                        ...
                        <div className="p-4 sm:p-6 max-h-[calc(100vh-120px)] overflow-y-auto">
                            ...
                            <div className="bg-white rounded-2xl p-4 sm:p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-6">
                                    ...
                                    <div className="bg-red-50 p-3 sm:p-4 rounded-xl hover:bg-red-100 transition-colors duration-200">
                                        <span className="text-sm font-medium text-red-600 block mb-1">Amount</span>
