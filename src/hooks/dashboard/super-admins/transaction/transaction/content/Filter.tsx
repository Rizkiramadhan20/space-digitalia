...
import { FilterProps } from '@/hooks/dashboard/super-admins/transaction/transaction/lib/schema'
...
export default function Filter({
    ...
    const handlePaymentMethodFilter = (id: string) => {
        setFilters(prev => ({
            ...prev,
    ...
    const handlePaymentTypeFilter = (id: string) => {
        setFilters(prev => ({
            ...prev,
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            {[
                                ...
                                <div
                                    key={id}
                                    onClick={() => handlePaymentMethodFilter(id)}
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            {[
                                ...
                                <div
                                    key={id}
                                    onClick={() => handlePaymentTypeFilter(id)}
                                    className={`cursor-pointer px-4 py-3 rounded-2xl border-2 transition-all duration-300 flex items-center gap-2
