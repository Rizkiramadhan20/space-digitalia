...
import { TypeFormModalProps } from '@/hooks/dashboard/super-admins/project/type/lib/schema'
            ...
            <div className="fixed inset-0 backdrop-blur-sm z-50 overflow-y-auto">
                <div className="flex items-center justify-center min-h-screen p-4">
                    <div className="bg-white rounded-3xl shadow-2xl w-[90%] max-w-2xl p-8">
                        <div className="flex items-center justify-between mb-6">
                            <div className="space-y-1">
                                ...
                                <p className="text-sm text-gray-500">
                                    {isEditing ? 'Update existing type' : 'Add a new type to your projects'}
                                </p>
                            </div>
                            <button
                                onClick={closeModal}
                        ...
                        <form method="dialog" onSubmit={handleSubmit} className="space-y-8">
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    <label className="text-sm font-medium text-gray-700">Type Title</label>
                                    <input
                                        type="text"
