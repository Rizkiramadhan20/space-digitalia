...
import CategoryModal from '@/hooks/dashboard/super-admins/article/category/CategoryModal';

import CategoryList from '@/hooks/dashboard/super-admins/article/category/CategoryList';
...
import CategorySkeleton from '@/hooks/dashboard/super-admins/article/category/CategorySkelaton';
