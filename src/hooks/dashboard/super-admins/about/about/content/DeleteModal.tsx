...
import { DeleteModalProps } from '@/hooks/dashboard/super-admins/about/about/lib/schema';

export default function DeleteModal({ deleteLoading, onConfirm, onCancel }: DeleteModalProps) {
    return (
